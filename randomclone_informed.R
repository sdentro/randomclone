...
png(file.path(outdir, paste0(samplename, "_solutions.png")), height=800, width=1000)
grid.arrange(truth_plot, binom_plot, binom_2_plot, binom_diff_plot, aic_plot, bic_plot, ll_plot, ncol=2, 
